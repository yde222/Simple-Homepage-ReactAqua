...
//				"/cop/bbs/*Master*.do",
			...
			.excludePathPatterns(
				...
				"/uat/uia/insertLoginAPI.do",
				"/uat/uia/updateLoginAPI.do",
				"/uat/uia/selectBoardLoginArticleAPI.do",
				"/uat/uia/deleteBoardLoginArticleAPI.do",
				"/uat/uia/selectBoardLoginListAPI.do"

				);
		//김평권추가, /uat/uia/insertLoginAPI.do, 5파트, cors대응
