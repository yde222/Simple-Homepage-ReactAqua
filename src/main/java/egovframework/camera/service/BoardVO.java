...
public class BoardVO extends Board implements Serializable {
   ...
   private String bbsTyECode = "";
   
   private String bbsTyFCode = "";
   
   private String bbsTyGCode = "";
   
   private String bbsTyHCode = "";
   ...
   public String getBbsTyACode() {
	...
	public String getBbsTyECode() {
		return bbsTyECode;
	}

	public void setBbsTyECode(String bbsTyECode) {
		this.bbsTyECode = bbsTyECode;
	}

	public String getBbsTyFCode() {
		return bbsTyFCode;
	}

	public void setBbsTyFCode(String bbsTyFCode) {
		this.bbsTyFCode = bbsTyFCode;
	}

	public String getBbsTyGCode() {
		return bbsTyGCode;
	}

	public void setBbsTyGCode(String bbsTyGCode) {
		this.bbsTyGCode = bbsTyGCode;
	}

	public String getBbsTyHCode() {
		return bbsTyHCode;
	}

	public void setBbsTyHCode(String bbsTyHCode) {
		this.bbsTyHCode = bbsTyHCode;
	}
