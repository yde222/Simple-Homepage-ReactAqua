            ...
            <div className="Plogin">
                ...
                <div className="login_box">
                    ...
                    <ul style={mystyle}>
                        <br />
                        <pre style={preStyle}>
                        <Link to={URL.LOGIN_CREATE} className="btn btn_blue_h46 pd35"><span>회원가입</span></Link>
                        </pre>

                        <pre>
                        <Link to={URL.LOGIN_MODIFY} className="btn btn_blue_h46 pd35"><span>비밀번호 찾기</span></Link>
                        </pre>
                    </ul>
                ...
                <ul className="list">
                    <li>비밀번호는 8~12자의 영문 대/소문자, 숫자, 특수문자를 혼합해서 사용하실 수 있습니다.</li>
