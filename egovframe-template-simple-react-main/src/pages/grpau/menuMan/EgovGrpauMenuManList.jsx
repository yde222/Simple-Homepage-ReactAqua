...
function EgovGrpauMenuManList(props) {
    console.group("EgovGrpauMenuManList");
    console.log("[Start] EgovGrpauMenuManList ------------------------------");
    console.log("EgovGrpauMenuManList [props] : ", props);
...
//    const bbsId = NOTICE_BLDN_ID;
    ...
    const retrieveList = useCallback( (searchCondition) => {
        ...
        const retrieveListURL = '/sym/mnu/mpm/EgovMenuManageSelect.do';
...
//				setBoardDetail(resp.result.groupManageVO);
                ...
                resp.result.resultList.forEach(function (item, index) {
                    ...
                    mutListTag.push(
                        <Link to={{pathname: URL.GRPAU_MEMU_MAN_DETAIL}} 
                        state={{
                            menuNo: item.menuNo
                        }} 
        ...
        console.groupEnd("EgovGrpauMenuManList.retrieveList()");
    },[]);

//복수건 삭제
const multiDel = (checkedList) => {
    const formData = new FormData();
    const deleteBoardURL = "/sym/mnu/mpm/EgovMenuManageListDelete.do";
...
//    alert(groupCode);
    ...
    EgovNet.requestFetch(deleteBoardURL,
        requestOptions,
        (resp) => {
            console.log("====>>> 데이터 삭제 확인 = ", resp);
            if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                    alert("선택된 데이터가 삭제되었습니다.")
                    navigate(URL.GRPAU_MEMU_MAN,   
                        {state: {
                    }
                });
                setCheckedList([]);
...
useEffect(function() {
    ...
    console.log("------------------------------EgovGrpauMenuManList [End]");
    console.groupEnd("EgovGrpauMenuManList");
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <div className="condition">
                            <ul>
                                ...
                                <li>
                                    <Link to={URL.GRPAU_MEMU_MAN_CREATE} className="btn btn_blue_h46 pd35">등록</Link>
                                </li>
								<li>
                                ...
                                <li>
                                    <Link to={URL.GRPAU_MEMU_MAN_MULTI} className="btn btn_blue_h46 pd35">일괄등록</Link>
                                </li>
                            </ul>
                        </div>
                        {/* <!--// 검색조건 test--> */}
...
export default EgovGrpauMenuManList;