...
//  const [modalOpen, setModalOpen] = useState(false);
  ...
  const closeModal = () => {
    ...
    const retrieveDetailCom22Id = () => {
		...
		searchCondition.authorCode = authorCode;
        const retrieveDetailURL = '/sym/mnu/mcm/EgovMenuCreatSelect.do';
    ...
    //여기서도 값 6
     //console.log("bbsTyACodeOptions111 index1: ", bbsTyACodeOptions);
                if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                    console.log("retrieveDetailCom22Id tree data 습득");
                	//소속기관코드 습득
//                    retrieveDetailCom25Id();
  ...
  return (
    <React.Fragment>
      ...
      <Modal open={modalOpen} close={closeModal} header={authorCode}>
