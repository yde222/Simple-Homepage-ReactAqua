...
import EgovAdminOper2Edit from './EgovAdminOper2Edit'; // EgovAdminNoticeLandEdit 컴포넌트 경로로 수정
import EgovAdminNoticeLandEdit from '../noticeLand/EgovAdminNoticeLandEdit';
...
function EgovAdminNoticeLandList(props) {
                ...
                resp.result.resultList.forEach(function (item, index) {
                    ...
                    mutListTag.push(
                        <Link to={{
                            ...
                            <div>{listIdx}</div>
                            <div>{item.nttSj}</div>
                        	<Link to={{pathname: URL.ADMIN_OPER2}} 
                            state={{
                                nttId: item.nttId,
                                bbsId: item.bbsId,
    ...
    return (
            ...
            <div className="c_wrap">
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <h2 className="tit_2">물고기 대장(꺽기선+파이)</h2>
       ...
       {/* 편집 컴포넌트 추가 */}
        <EgovAdminNoticeLandEdit  dataList={dataList} />
        <EgovAdminOper2Edit dataList={dataList} />
