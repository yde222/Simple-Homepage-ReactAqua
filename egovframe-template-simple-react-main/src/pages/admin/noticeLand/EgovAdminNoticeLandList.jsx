...
import EgovAdminNoticeLandEdit from './EgovAdminNoticeLandEdit'; // EgovAdminNoticeLandEdit 컴포넌트 경로로 수정
                ...
                resp.result.resultList.forEach(function (item, index) {
                    ...
                    mutListTag.push(
                        <Link to={{
                            ...
                            <div>{listIdx}</div>
                            <div>{item.nttSj}</div>
                        	<Link to={{pathname: URL.ADMIN_NOTICE_LAND}} 
                            state={{
                                nttId: item.nttId,
                                bbsId: item.bbsId,
            ...
            <div className="c_wrap">
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <h2 className="tit_2">물고기 대장(꺽기선)</h2>
