...
import EgovAdminGalleryEdit from './EgovAdminGalleryEdit'; // EgovAdminNoticeLandEdit 컴포넌트 경로로 수정
...
function EgovAdminGalleryList(props) {
    ...
    return (
            ...
            <div className="c_wrap">
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <h2 className="tit_2">물고기 대장(막대)</h2>
       ...
       {/* 편집 컴포넌트 추가 */}
        <EgovAdminGalleryEdit dataList={dataList} />
