...
//    const history = useHistory();
    ...
    const retrieveDetail = (searchCondition) => {
        const retrieveDetailURL = '/cop/est/jusoDetail.do';
...
const jusoDelDetail = (bbsId, nttId, dtlId) => {
    ...
    const deleteBoardURL = "/cop/est/jusoDelDetail.do";
    ...
    EgovNet.requestFetch(deleteBoardURL,
        ...
        (resp) => {
            ...
            if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                    ...
                    //history.push({ 
                        navigate(URL.ADMIN_NOTICE_EST_JUSO_DETAIL,   
                        {state: {
                            bbsId: bbsId,
                            nttId: nttId,
                    }
...
const deleteBoardURL = "/cop/est/deleteBoardArticleAPI2.do";    
    const requestOptions = {
        method: "POST",
        headers: {
            'Content-type': 'application/json'
...
const jusoNoIssDetail = (bbsId, nttId, checkedList) => {
     const formData = new FormData();
     const deleteBoardURL = "/cop/est/jusoNoIssDetail.do";
...
const jusoCvtDetail = (bbsId, nttId, dtlId) => {
    const formData = new FormData();
    const deleteBoardURL = "/cop/est/jusoCvtDetail.do";
...
const jusoCompDetail = (bbsId, nttId) => {
    const formData = new FormData();
    const deleteBoardURL = "/cop/est/jusoCompDetail.do";
...
const jusoAllNoIssDetail = (bbsId, nttId) => {
    const formData = new FormData();
    const deleteBoardURL = "/cop/est/jusoAllNoIssDetail.do";
...
export default EgovAdminNoticeEstJusoDetail;