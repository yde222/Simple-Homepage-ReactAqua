...
function EgovAdminNoticeCorpJusoDetail(props) {
    ...
    const retrieveDetail = (searchCondition) => {
        const retrieveDetailURL = '/cop/corp/jusoDetail.do';
        ...
        EgovNet.requestFetch(retrieveDetailURL,
            ...
            function (resp) {
                ...
                resp.result.resultList.forEach(function (item, index) {
                    ...
                    mutListTag.push(
                        <div to={{
                            pathname: URL.ADMIN_NOTICE_CORP_JUSO_DETAIL,
                            state: {
                                nttId: item.nttId,
                                bbsId: item.bbsId,
                                dtlId: item.dtlId,
...
const jusoDelDetail = (bbsId, nttId, dtlId) => {
    ...
    const deleteBoardURL = "/cop/corp/jusoDelDetail.do";
    ...
    EgovNet.requestFetch(deleteBoardURL,
        ...
        (resp) => {
            ...
            if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                    ...
                    navigate(URL.ADMIN_NOTICE_CORP_JUSO_DETAIL,   
                        {state: {
                            bbsId: bbsId,
                            nttId: nttId,
                    }
...
const deleteBoardURL = "/cop/corp/deleteBoardArticleAPI2.do";    
    const requestOptions = {
        method: "POST",
        headers: {
            'Content-type': 'application/json'
...
const jusoNoIssDetail = (bbsId, nttId, checkedList) => {
     const formData = new FormData();
     const deleteBoardURL = "/cop/corp/jusoNoIssDetail.do";
...
const jusoCvtDetail = (bbsId, nttId, dtlId) => {
    const formData = new FormData();
    const deleteBoardURL = "/cop/corp/jusoCvtDetail.do";
...
const jusoCompDetail = (bbsId, nttId) => {
    const formData = new FormData();
    const deleteBoardURL = "/cop/corp/jusoCompDetail.do";
...
const jusoAllNoIssDetail = (bbsId, nttId) => {
    const formData = new FormData();
    const deleteBoardURL = "/cop/corp/jusoAllNoIssDetail.do";
...
export default EgovAdminNoticeCorpJusoDetail;