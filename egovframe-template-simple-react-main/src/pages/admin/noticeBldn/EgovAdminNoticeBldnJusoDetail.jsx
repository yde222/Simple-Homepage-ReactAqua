...
function EgovAdminNoticeBldnJusoDetail(props) {
    ...
    // console.log("EgovAdminNotice JUSO Detail [location] : ", location);
    ...
    const retrieveDetail = (searchCondition) => {
        const retrieveDetailURL = '/cop/bldn/jusoDetail.do';
        ...
        EgovNet.requestFetch(retrieveDetailURL,
            ...
            function (resp) {
                ...
                resp.result.resultList.forEach(function (item, index) {
                    ...
                    mutListTag.push(
                        <div to={{
                            pathname: URL.ADMIN_NOTICE_BLDN_JUSO_DETAIL,
                            state: {
                                nttId: item.nttId,
                                bbsId: item.bbsId,
                                dtlId: item.dtlId,
...
const jusoDelDetail = (bbsId, nttId, dtlId) => {
    ...
    const deleteBoardURL = "/cop/bldn/jusoDelDetail.do";
    ...
    EgovNet.requestFetch(deleteBoardURL,
        ...
        (resp) => {
            ...
            if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                    ...
                    navigate(URL.ADMIN_NOTICE_BLDN_JUSO_DETAIL,   
                        {state: {
                            bbsId: bbsId,
                            nttId: nttId,
                    }
...
const deleteBoardURL = "/cop/bldn/deleteBoardArticleAPI2.do";    
    const requestOptions = {
        method: "POST",
        headers: {
            'Content-type': 'application/json'
...
const jusoNoIssDetail = (bbsId, nttId, checkedList) => {
     const formData = new FormData();
     const deleteBoardURL = "/cop/bldn/jusoNoIssDetail.do";
...
const jusoCvtDetail = (bbsId, nttId, dtlId) => {
    const formData = new FormData();
    const deleteBoardURL = "/cop/bldn/jusoCvtDetail.do";
...
const jusoCompDetail = (bbsId, nttId) => {
    const formData = new FormData();
    const deleteBoardURL = "/cop/bldn/jusoCompDetail.do";
...
const jusoAllNoIssDetail = (bbsId, nttId) => {
    const formData = new FormData();
    const deleteBoardURL = "/cop/bldn/jusoAllNoIssDetail.do";
...
export default EgovAdminNoticeBldnJusoDetail;