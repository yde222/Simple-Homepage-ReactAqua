...
//다국어지원 임포트 
import enUsMsg from "../../AquaLang/EgovLoginCreate_en-us.json";
import koMsg from "../../AquaLang/EgovLoginCreate_ko.json";
import { IntlProvider } from 'react-intl'; 
import { FormattedMessage } from 'react-intl';


function EgovLoginCreate(props) {
    ...
    const [loginDetail, setLoginDetail] = useState({ email: "", name: "", password: "", passwordCnsr: "" });
...
//    const [boardAttachFiles, setBoardAttachFiles] = useState();
    ...
    const initMode = () => {
    console.log("EgovLoginCreate [props.mode] :11 ", props.mode);
    switch (props.mode) {
    ...
    const retrieveDetail = () => {
        ...
        if (modeInfo.mode === CODE.MODE_CREATE) {// 등록이면 조회 안함
            setLoginDetail({ bbsId: bbsId, email: "", name: "", password: "", passwordCnsr: "" });
            ...
            <div className="c_wrap">
                ...
                <div className="layout">
                    ...
                    <div className="contents PDS_REG" id="contents">
                        ...
                        <h2 className="tit_2"><FormattedMessage id="tit_2" defaultMessage="회원가입"/></h2>
                            ...
                            <div className="info2">
                                ...
                                <div className="board_view2">
                                    <dl>
                                		...
                                		<li>
                                    		<Link to={URL.LOGIN_CREATE} className="btn btn_blue_h46 pd35">
											<FormattedMessage id="sendCodeButton" defaultMessage="인증번호전송"/>
											</Link>
                                		</li>
                                    </dl>
                                    <dl>
                                        <dt><label htmlFor="password">
											<FormattedMessage id="password" defaultMessage="비밀번호"/><span className="req">필수</span></label></dt>
                                        <dd>
                                    ...
                                    <dl>
										...
										<FormattedMessage id="passwordCnsr" defaultMessage="비밀번호확인"/>
										<span className="req">필수</span></label></dt>
                                        <dd>
                        ...
                        <div className="board_btn_area">
                            <div className="left_col btn1">
                                ...
                                onClick={() => updateLogin()}>
							<FormattedMessage id="SignUpbtn" defaultMessage="회원가입"/>
							</button>
                             </div>
...
export default EgovLoginCreate;